...
public class GoodsDetailAuctionServerDao extends BaseDao {
    ...
    public String pid;
    public String mid;
    public String party_type;//party拍卖,seckill秒杀，sale满减
    public GoodsDetail goodsDetail = new GoodsDetail();
    public List<BannerInfo> bannerInfoList = new ArrayList<>();

    public GoodsDetailAuctionServerDao(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public void exec() throws Exception {
        String url = Constants.URL_GOODS_DETIAL;
        Map<String, String> maps = new HashMap<String, String>();
        maps.put("goods_id",agid);
        maps.put("party_id",pid);
        maps.put("mid",mid);
