 ...
 */
public class ModifyAddressActivity extends BaseActivity implements View.OnClickListener, OnWheelChangedListener, OnWheelScrollListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.zpf_activity_modify_address);
    ...
    private void deleteData() {
        ...
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
                final DelAddressServerDao serverDao = new DelAddressServerDao(ModifyAddressActivity.this);
                serverDao.mid = getUserId(ModifyAddressActivity.this);
                serverDao.address_id = address_id;
                serverDao.loadData(new BaseDao.IDaoCallback() {
                    @Override
                    public void exec(boolean success, Object obj) {
                        if (serverDao.isSucc) {
                            ToastUtils.show(ModifyAddressActivity.this, "删除成功");
                            finish();
                        } else
                            ToastUtils.show(ModifyAddressActivity.this, serverDao.desc);
                    }
                });
            }
        });
     ...
     */
    public void getData() {
        final AddressInfoServerDao serverDao = new AddressInfoServerDao(this);
        ...
        serverDao.loadData(new BaseDao.IDaoCallback() {
            ...
            public void exec(boolean success, Object obj) {
                if (serverDao.isSucc) {
                    et_name.setText(serverDao.address.getReceiver_name());
                    et_phone.setText(serverDao.address.getReceiver_phone());
                    tv_area.setText(serverDao.address.getAddr_area());
                    et_addr.setText(serverDao.address.getAddr_detail());
                } else
                    ToastUtils.show(ModifyAddressActivity.this, serverDao.desc);
            }
        });
