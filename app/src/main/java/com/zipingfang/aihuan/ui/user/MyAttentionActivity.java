...
public class MyAttentionActivity extends BaseActivity implements View.OnClickListener {
    private AttentionPartyFragment partyFragment = new AttentionPartyFragment();
    private AttentionGoodsFragment goodsFragment = new AttentionGoodsFragment();
    ...
    private void initFragment(){
        fragments.add(new AttentionGoodsFragment());
        fragments.add(new AttentionPartyFragment());
    }
