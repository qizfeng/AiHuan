 ...
 */
public class RecyclerJiangjiaAdapter extends RecyclerView.Adapter<RecyclerJiangjiaAdapter.ViewHolder> {

    private List<Party> items;
    private int itemLayout;
    private Context mContext;

    public RecyclerJiangjiaAdapter(List<Party> items, int itemLayout, Context context) {
        this.items = items;
