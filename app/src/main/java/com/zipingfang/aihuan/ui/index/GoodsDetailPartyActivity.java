...
public class GoodsDetailPartyActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void doAttention(){
        ...
        serverDao.loadData(new BaseDao.IDaoCallback() {
            ...
            public void exec(boolean success, Object obj) {
                if(serverDao.isSucc){
                    ToastUtils.show(GoodsDetailPartyActivity.this,"关注成功");
                }else {
                    ToastUtils.show(GoodsDetailPartyActivity.this,serverDao.desc);
                }
            }
        });
    }
