...
public class GoodsAllAdapter extends BaseAdapter {
    ...
    public GoodsAllAdapter(Context mContext, List<Goods> mData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(R.layout.zpf_item_goods, null);
        ...
        holder.tv_sale.setText("已售 "+item.getSale_num());
