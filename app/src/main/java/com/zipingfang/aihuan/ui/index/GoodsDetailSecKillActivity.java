...
public class GoodsDetailSecKillActivity extends BaseActivity implements View.OnClickListener {
...
//        webSettings.setBuiltInZoomControls(true);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.tv_pay_deposit:
                if (isLogin(GoodsDetailSecKillActivity.this)) {

                } else {
                    DeleteDialog.Builder builder = new DeleteDialog.Builder(GoodsDetailSecKillActivity.this);
                    builder.setMessage("未登录,此功能不可用");
                    builder.setTitle("提示");
                    builder.setPositiveButton("登录", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                            Intent intent = new Intent(GoodsDetailSecKillActivity.this, LoginActivity.class);
    ...
    private void doAttention() {
        ...
        serverDao.type = "seckill";
        serverDao.agid=agid;
        serverDao.loadData(new BaseDao.IDaoCallback() {
            @Override
            public void exec(boolean success, Object obj) {
                if (serverDao.isSucc) {
                    ToastUtils.show(GoodsDetailSecKillActivity.this, "关注成功");
                } else {
                    ToastUtils.show(GoodsDetailSecKillActivity.this, serverDao.desc);
                }
            }
        });
    }
        ...
        serverDao.loadData(new BaseDao.IDaoCallback() {
            ...
            public void exec(boolean success, Object obj) {
                if (serverDao.isSucc) {
                    ...
                    if (serverDao.bannerInfoList != null) {
...
//                    initBottomImage(goodsDetail.getCover());
    ...
    private void bindData(GoodsDetail goodsDetail) {
        ...
        tv_price_type.setText("秒杀价");
        tv_goods_now_price.setText("￥" + goodsDetail.getMax_price());
        tv_apply.setText("限购 " + goodsDetail.getApply_count());
        tv_hot.setText("售出 " + goodsDetail.getCnt());
        ...
        tv_price_count.setText("剩余 " + goodsDetail.getPrice_count());
        ...
        } else if ("秒杀中".equals(goodsDetail.getStatus_describe())) {
