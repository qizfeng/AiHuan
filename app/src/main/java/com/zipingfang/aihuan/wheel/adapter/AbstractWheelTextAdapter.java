 ...
 */
package com.zipingfang.aihuan.wheel.adapter;
...
//				}
//				setTextSize(textView,index,currentIndex);
	...
	public void setTextSize(TextView textView,int position,int currentIndex){
